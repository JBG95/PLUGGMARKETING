export const Items = [
  {
    description:
      "Secure premium advertising spots across top media channels to boost your brand's visibility locally and globally.",
    icon: (
  ...
  {
    description:
      "Engage your audience with dynamic ad campaigns that create buzz and drive high-impact interactions.",
    icon: (
  ...
  {
    description:
      "Drive targeted engagement with strategic ad placements that convert impressions into action.",
    icon: (
  ...
  {
    description:
      "Leverage strategic partnerships with top media outlets and influencers to amplify your advertising message.",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" height="1em" width="1em">
  ...
  {
    description:
      "Refine your campaign strategy with real-time analytics and insights to maximize ROI and drive continuous improvement.",
    icon: (
