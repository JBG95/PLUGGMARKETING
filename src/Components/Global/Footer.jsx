  ...
  return (
    <footer className="body-font bg-black w-full text-white pt-14 px-4 md:px-8">
            ...
            <nav className="list-none mb-10 flex flex-col gap-3 text-sm ">
              ...
              <li>
                <a className="text-gray-400 cursor-pointer hover:text-gray-500">
                  Enterprise banking and consumer finance
                </a>
              </li>
              <li>
      ...
      <div className="flex w-full px-8 lg:px-20 text-gray-500 text-center md:text-left pb-10">
        <p>
          It&#39;s important to note that while bond tokenization offers these potential benefits, it also presents challenges and regulatory considerations. As with any emerging technology, thorough evaluation and adherence to regulatory frameworks are crucial to ensure investor protection, market integrity, and compliance with existing financial regulations.
        </p>
      </div>
    </footer>
  );
